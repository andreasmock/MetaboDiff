...
output:
  BiocStyle::html_document:
    ...
    toc_float: true
abstract: |
    Correlation network analysis has been successfully applied in comparative transcriptomics to reveal changes in meaningful biological subpathways (modules). The first part of this document describes an adaptation for metabolomic data analysis. In the second part, the methodology is benchmarked and discussed in three case studies.
vignette: |
...
# Part II: Benchmarking of metabolic correlation networks
...
Study design: Tissue metabolomics of 40 prostate cancers vs. 16 normal prostate specimens  
Vendor: Metabolon  
Data availability: 307 named metabolites  
Name of object in MetaboDiff: `met_example`
