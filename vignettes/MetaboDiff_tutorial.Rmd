...
```{r MOIplot, fig.cap="Exploration of module of interest. Module membership is plotted over the -log10 p-value. The dashed line marks the significance threshold of adjusted p-value<0.05."}
MOI_plot(met,
         group_factor="tumor_normal",
         MOI=2) + xlim(c(0,5)) 
```
