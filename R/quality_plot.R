...
quality_plot <- function(met, group_factor, label_colors) {
    ...
    plot2 = ggplot(mdata,
        ...
        theme(axis.text.x=element_blank()) + ylab("log2(imputed raw abundance)") +
        scale_fill_manual(values=label_colors, name="group factor")
    ...
    plot3 = ggplot(mdata,
        ...
        theme(axis.text.x=element_blank()) + ylab("normalized abundance") +
        scale_fill_manual(values=label_colors, name="group factor")
    ...
    plot4 = ggplot(mdata,
        ...
        theme(axis.text.x=element_blank()) + ylab("normalized & imputed abundance") +
        scale_fill_manual(values=label_colors, name="group factor")
